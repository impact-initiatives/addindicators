...
#   )
#   expect_warning(add_fcs(df1, fcs_cereal="cereal", fcs_legumes="pulses", fcs_veg="vegetables",
#                          fcs_fruit = "fruits", fcs_meat = "meat", fcs_dairy="milk", fcs_sugar="sugar", fcs_oil="oil"),
#                  "There is already a variable called fcs_score in your dataset, it will be overwritten")
# })
