testthat::test_that("testing add_lcsi", {
  ...
  output_data1 <- data.frame(
    ...
    emergency2 =          c("No", "Not Applicable", "Yes", "Not Applicable", "No"),
    emergency3 =          c("Not Applicable", "No", "Not Applicable", "No", "Exhausted"),
    lcsi_stress1 = c("2", "2", "3", "4", "2"),
    lcsi_stress2 = c("2", "1", "4", "2", "2"),
    lcsi_stress3 = c("4", "4", "1", "2", "2"),
    lcsi_stress4 = c("4", "2", "1", "1", "2"),
    lcsi_crisis1 = c("2", "4", "1", "3", "2"),
    lcsi_crisis2 = c("2", "2", "2", "2", "2"),
    lcsi_crisis3 = c("2", "2", "1", "4", "2"),
    lcsi_emergency1 = c("2", "4", "4", "2", "2"),
    lcsi_emergency2 = c("2", "4", "1", "4", "2"),
    lcsi_emergency3 = c("4", "2", "4", "2", "3"),
